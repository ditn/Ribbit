...
import com.adambennett.ribbit.app.adapters.MessageAdapter;
...
public class InboxFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout.setOnRefreshListener(mOnRefeshListener);
    ...
    protected SwipeRefreshLayout.OnRefreshListener mOnRefeshListener = new SwipeRefreshLayout.OnRefreshListener() {
        @Override
